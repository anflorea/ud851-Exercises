...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        String sizeString = mNewPartySizeEditText.getText().toString();
        ...
        // COMPELTED (11) Use Integer.parseInt to parse mNewPartySizeEditText.getText to an integer
        ...
        try {
            ...
            Log.e(LOG_TAG, pikachu.toString());
        }
