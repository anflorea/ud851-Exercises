...
public class NotificationUtils {
    ...
    private static final int ACTION_DISMISS_PENDING_INTENT_ID = 4516;

    private static final int ACTION_INCREMENT_PENDING_INTENT_ID = 1235;
    ...
    //      COMPLETED (9) Create an Action for the user to ignore the notification (and dismiss it)
        NotificationCompat.Action dismissAction = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px, "I don't wanna", pendingIntent);
    ...
    //      COMPLETED (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action drinkAction = new NotificationCompat.Action(R.drawable.ic_drink_notification, "I did", pendingIntent);
