...
public class ReminderTasks {
    ...
    public static final String ACTION_ISSUE_NOTIFICATION = "issue-reminder-notification";
    ...
    public static void executeTask(Context context, String action) {
        ...
        } else if (ACTION_ISSUE_NOTIFICATION.equals(action)) {
            issueReminderNotification(context);
        }
    }
    ...
    private static void issueReminderNotification(Context context) {
