...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String QUERY_URL_KEY = "query_key";

    // COMPLETED (2) Create a static final key to store the search's raw JSON
    private static final String QUERY_RAW_JSON_KEY = "json_key";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String urlString = savedInstanceState.getString(QUERY_URL_KEY);
            String jsonString = savedInstanceState.getString(QUERY_RAW_JSON_KEY);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(QUERY_RAW_JSON_KEY, jsonString);
